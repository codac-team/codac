...
void export_SepCartProd(py::module& m, py::class_<Sep_,pySep>& pysep)
{
  ...
  exported
    ...
    .def(py::init([](const Sep_& s1, const Sep_& s2, const Sep_& s3, const Sep_& s4, const Sep_& s5, const Sep_& s6, const Sep_& s7, const Sep_& s8) {
    ...
    .def(py::init([](const Sep_& s1, const Sep_& s2, const Sep_& s3, const Sep_& s4, const Sep_& s5, const Sep_& s6, const Sep_& s7, const Sep_& s8, const Sep_& s9) {
    ...
    .def(py::init([](const Sep_& s1, const Sep_& s2, const Sep_& s3, const Sep_& s4, const Sep_& s5, const Sep_& s6, const Sep_& s7, const Sep_& s8, const Sep_& s9, const Sep_& s10) {
  ...
  m.def("cart_prod_sep", [](const std::list<std::reference_wrapper<Sep_>>& l)
      {
        Collection<Sep_> c;
        for(const auto& si : l)
