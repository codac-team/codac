...
void export_CtcProj(py::module& m, py::class_<CtcBase<IntervalVector>,pyCtcIntervalVector>& pyctc)
{
  ...
  exported
    ...
    .def(py::init(
        ...
        {
          return std::make_unique<CtcProj>(c.copy(), matlab::convert_indices(proj_indices), default_eps);
        }),
    ...
    .def(py::init(
        ...
        {
          return std::make_unique<CtcProj>(c.copy(), matlab::convert_indices(proj_indices), y, default_eps);
        }),
