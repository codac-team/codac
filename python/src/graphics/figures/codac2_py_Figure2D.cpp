...
void export_Figure2D(py::module& m)
{
  ...
  exported
    ...
    .def("draw_zonotope", &Figure2D::draw_zonotope,
      VOID_FIGURE2D_DRAW_ZONOTOPE_CONST_VECTOR_REF_CONST_MATRIX_REF_CONST_STYLEPROPERTIES_REF,
      "z"_a, "A"_a, "style"_a=StyleProperties())
  ...
  exported_default_view
    ...
    .def_static("draw_zonotope", &DefaultFigure::draw_zonotope,
      STATIC_VOID_DEFAULTFIGURE_DRAW_ZONOTOPE_CONST_VECTOR_REF_CONST_MATRIX_REF_CONST_STYLEPROPERTIES_REF,
      "z"_a, "A"_a, "style"_a=StyleProperties())
