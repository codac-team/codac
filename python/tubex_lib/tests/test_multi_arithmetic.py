...
class TestArithmeticOnTube(unittest.TestCase):
  ...
  def test_pow(self):
    ...
    testtubex = Tube(Interval(0,1),0.1,Interval(3))
    testtubey = Tube(Interval(0,1),0.1,Interval(4))
    self.assertApproxIntv(pow(testtubex,testdy).codomain(),Interval(81.))
    self.assertApproxIntv(pow(testtubex,testintvy).codomain(),Interval(81.))
  ...
  def test_atan2(self):
    ...
    testtubex = Tube(Interval(0,1),0.1,Interval(3))
    testtubey = Tube(Interval(0,1),0.1,Interval(4))
    self.assertApproxIntv(atan2(testtubey,testtubex).codomain(),Interval(0.9272952180016122))
    self.assertApproxIntv(atan2(testtubey,testdx).codomain(),Interval(0.9272952180016122))
    self.assertApproxIntv(atan2(testdy,testtubex).codomain(),Interval(0.9272952180016122))
    self.assertApproxIntv(atan2(testtubey,testintvx).codomain(),Interval(0.9272952180016122))
    self.assertApproxIntv(atan2(testintvy,testtubex).codomain(),Interval(0.9272952180016122))
