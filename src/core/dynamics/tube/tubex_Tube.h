...
namespace tubex
{
  ...
  class Tube : public DynamicalItem
  {
    public:
      ...
      /**
       * \brief Creates a scalar tube \f$[x](\cdot)\f$ from a tubex::TimeFnc object and with some temporal discretization
       *
       * \note Due to the slicing implementation of the tube, a wrapping
       *       effect will occur to reliably enclose the tubex::TimeFnc object 

       * \param tdomain temporal domain \f$[t_0,t_f]\f$
       * \param timestep sampling value \f$\delta\f$ for the temporal discretization (double)
       * \param f tubex::TimeFnc object that will be enclosed by the tube:
       ...
       */
      Tube(const ibex::Interval& tdomain, double timestep, const tubex::TimeFnc& f, int f_image_id = 0);
      ...
      /**
       * \brief Creates a copy of a scalar tube \f$[x](\cdot)\f$, with the same time
       *        discretization but a specific codomain defined by a tubex::TimeFnc object
       *
       * \note Due to the slicing implementation of the tube, a wrapping
       *       effect will occur to reliably enclose the tubex::TimeFnc object 
       *
       ...
       */
      Tube(const Tube& x, const tubex::TimeFnc& f, int f_image_id = 0);
       ...
       *
       * \note The values and sampling (slices and gates) are serialized
       * \note The serialization of a Trajectory defined from a tubex::TimeFunction object is not supported
