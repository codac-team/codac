...
namespace tubex
{
  // Public methods
    ...
    Trajectory::Trajectory(const Interval& tdomain, const tubex::Function& f)
      : m_tdomain(tdomain), m_traj_def_type(TrajDefnType::ANALYTIC_FNC), m_function(new tubex::Function(f))
    {
    ...
    Trajectory::Trajectory(const Interval& tdomain, const tubex::Function& f, double timestep)
