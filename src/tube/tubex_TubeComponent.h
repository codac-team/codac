...
namespace tubex
{
  ...
  class TubeComponent
  {
    ...
    /** Base: **/
      ...
      ibex::Interval interpol(double t, const TubeComponent& derivative) const;
      ibex::Interval interpol(const ibex::Interval& t, const TubeComponent& derivative) const;
      //std::pair<ibex::Interval,ibex::Interval> partialInterpol(const ibex::Interval& t, const TubeComponent& derivative) const;
