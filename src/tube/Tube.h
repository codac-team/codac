...
class Tube
{
  public:
    ...
    /** Contractors **/
         ...
         * \brief To be defined...
         */
        bool ctcIn(const Tube& derivative_tube, ibex::Interval& y, ibex::Interval& t, bool fwd_bwd = true);
        bool ctcIn(const Tube& derivative_tube, const ibex::Interval& y, ibex::Interval& t, bool fwd_bwd = true);
