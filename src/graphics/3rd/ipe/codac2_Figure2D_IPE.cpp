...
{
  _colors.emplace(s.stroke_color.hex_str, s.stroke_color);
  _colors.emplace(s.fill_color.hex_str, s.fill_color);

  _f_temp_content << "\n \
    <path layer=\"alpha\" \n \
    stroke=\"codac_color_" << s.stroke_color.hex_str << "\" \n \
    fill=\"codac_color_" << s.fill_color.hex_str << "\" \n \
