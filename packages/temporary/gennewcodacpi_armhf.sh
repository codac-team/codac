...
sudo rm -Rf codac*
#git clone -b codac1 https://github.com/lebarsfa/codac
git clone -b codac1 https://github.com/codac-team/codac
cd codac
git submodule init
...
# For an unknown reason, this test appears to hang on bullseye, buster... \\
if [ \"\$(lsb_release -cs)\" = \"bookworm\" ]; then \
 python3 ../examples/tuto/01_getting_started/01_getting_started.py ; \
fi && \
