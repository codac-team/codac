...
if (!$pp['url']) { 
	$url = 'https://github.com/codac-team/codac/releases/download/v1/codac_x86_mingw15.zip'
	$checksum = 'EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE'
	$url64 = 'https://github.com/codac-team/codac/releases/download/v1/codac_x64_mingw15.zip'
