...
int main(int argc, char** argv)
{
  /* =========== LOADING DATA =========== */
    ...
    TrajectoryVector x_truth(tdomain, tubex::TimeFunction("(10*cos(t)+t;5*sin(2*t)+t)")); // actual trajectory
    TrajectoryVector v_truth(tdomain, tubex::TimeFunction("(-10*sin(t)+1;10*cos(2*t)+1)")); // actual velocity
