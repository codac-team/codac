...
int main(int argc, char** argv)
{
  ...
  /* =========== LOADING DATA =========== */
    ...
    TrajectoryVector x_truth(tdomain, tubex::TimeFunction("(10*cos(t)+t;5*sin(2*t)+t)"));
    x = new TubeVector(tdomain, dt, 2);
    v = new TubeVector(tdomain, dt, tubex::TimeFunction("(-10*sin(t)+1+[-0.2,0.2];10*cos(2*t)+1+[-0.2,0.2])"));
