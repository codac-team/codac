...
class TestIntervalVector(unittest.TestCase):
  ...
  def test_abs(self):
    a =  IntervalVector(2, Interval(-2,4))
    self.assertEqual(abs(a), IntervalVector(2, Interval(0,4)))
  ...
  # deprecated pyibex->codac: def test_tolist(self):
  # deprecated pyibex->codac:   a = IntervalVector([[1,2], [3, 4], [5, 6]])
  # deprecated pyibex->codac:   L = a.tolist()
  # deprecated pyibex->codac:   self.assertEqual(L, [1, 2, 3, 4, 5, 6])
